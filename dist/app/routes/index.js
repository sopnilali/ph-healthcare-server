...
const doctorSchedulte_route_1 = require("../modules/DoctorSchedule/doctorSchedulte.route");
...
const moduleRoutes = [
    ...
    {
        path: "/schedule",
        routes: schedule_route_1.ScheduleRoutes
    },
    {
        path: "/doctor-schedule",
        routes: doctorSchedulte_route_1.DoctorScheduleRoutes
    }
];
